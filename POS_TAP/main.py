...
from data.botones_rapidos import botones_rapidos
...
def main(page: ft.Page):
    ...
    # Usamos el primer botón
    boton = botones_rapidos[0]

    ticket = aplicar_boton(boton, ticket)

    print("Ticket actual:", ticket)
    page.update()
