        ...
        return ft.Column([
            ft.Row([
                ...
                ft.IconButton(
                    ...
                    icon_color="#38bdf8",
                    tooltip="Actualizar",
                    # BUG CORREGIDO: Llamaba a un método incorrecto que usaba una variable local 'lista' inexistente.
    ...
    def _cargar_historial(self):
        ...
        if not ventas:
            ...
            for i, v in enumerate(reversed(ventas), 1):
                ...
                # BUG CORREGIDO: Mostraba el diccionario crudo en la interfaz. Se formateó como texto de la forma (cantidad)x (producto).
