...
class DashboardView(ft.Container):
    ...
    def _build_ui(self):
        ...
        kpis = ft.Row([
            ...
            # BUG CORREGIDO: La ganancia estaba calculada al revés (gastos - ventas). Se cambió a data['ganancia'].
        ...
        barras = ft.Column(
            ...
            controls=[
                ft.Row([
                    ...
                    ft.Container(
                        # BUG CORREGIDO: Usaba la cantidad directamente como anchura sin escalar, lo que desbordaba el contenedor.
