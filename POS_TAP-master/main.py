...
from views.recetas_view import RecetasView 
...
def main(page: ft.Page):
    ...
    def change_route(e):
        ...
        if idx == 0:
            ...
            content_area.content = InsumosView(page, dm)
        elif idx == 6: # NUEVO
            content_area.content = RecetasView(page, dm)
        page.update()
    ...
    sidebar = ft.NavigationRail(
        ...
        destinations=[
            ...
            ft.NavigationRailDestination(icon=Icons.INVENTORY_2,   label="Insumos"), # NUEVO
            ft.NavigationRailDestination(icon=Icons.LIST_ALT,      label="Recetas"), # NUEVO
        ]
    )
